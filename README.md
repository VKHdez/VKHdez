...
<table width="100%">
  ...
  <tr>
    ...
    <td><strong>Linux (Alma Linux & Debian)</strong></td>
    <td>Manual Laravel, Yii2 & React JS apps deployment in VPS environment, private repositories, git hooks management y server security configuration</td>
  </tr>
  <tr>
